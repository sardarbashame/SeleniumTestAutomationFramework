...
public class Step2InsuredNameRiskLocationStepLA {
	
	WebDriver driver;
	JavascriptExecutor js = (JavascriptExecutor) driver;
	
	public Step2InsuredNameRiskLocationStepLA(WebDriver driver)
	{
		this.driver=driver;
	...
	public void insureNamerisklocation() throws InterruptedException
	{
	    ...
	    driver.findElement(By.xpath("//*[@data-omni-key='LAAboveBelowI90']//input")).click();
	    driver.findElement(By.xpath("//*[@data-omni-key='LAAboveBelowI90']//span[text()='North of I-90']")).click();
	    Thread.sleep(2000);

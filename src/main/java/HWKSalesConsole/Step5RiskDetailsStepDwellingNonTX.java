...
public class Step5RiskDetailsStepDwellingNonTX {
	
	WebDriver driver;
	JavascriptExecutor js = (JavascriptExecutor) driver;
	
	public Step5RiskDetailsStepDwellingNonTX(WebDriver driver)
	{
		this.driver=driver;
	...
	public void riskdetailstep(String CovALimit, String CovCLimit, String AOPDeductibledollaramount, String Winddeductibletype, String Windhailpercentage) throws InterruptedException
	{

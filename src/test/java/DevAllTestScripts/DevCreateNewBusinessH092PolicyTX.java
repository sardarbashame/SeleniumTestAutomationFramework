...
public class DevCreateNewBusinessH092PolicyTX extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		createNewOpportunity.createNewOpp(getParameters().getProperty("DEPARTMENT"), getParameters().getProperty("HOMELOB"),getParameters().getProperty("PRODTEAM"),getParameters().getProperty("DEV_RETAILER"),getParameters().getProperty("DEV_RETAILCONTACT"),getParameters().getProperty("DEV_INDACCOUNT"));

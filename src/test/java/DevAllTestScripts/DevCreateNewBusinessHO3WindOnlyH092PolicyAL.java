...
import HWKSalesConsole.Step5RiskDetailsStepHomeOwnersWindOnlyNonTX;
...
public class DevCreateNewBusinessHO3WindOnlyH092PolicyAL extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		createNewOpportunity.createNewOpp(
				...
				getParameters().getProperty("DEV_ORGACCOUNT")
				);
		...
		startQuoteStep.startstep(getParameters().getProperty("HO3WINDONLY"));
		...
		//Risk Details Step
		Step5RiskDetailsStepHomeOwnersWindOnlyNonTX risDetailsStep = new Step5RiskDetailsStepHomeOwnersWindOnlyNonTX(driver);

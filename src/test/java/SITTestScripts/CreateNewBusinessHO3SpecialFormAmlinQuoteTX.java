...
public class CreateNewBusinessHO3SpecialFormAmlinQuoteTX extends BaseTest {
	...
	// String quotename =	driver.findElement(By.xpath("//h1//div[text()='Quote']").getText();
		//Assert.assertEquals(()//*[text()='Quote')).getText(), "Quote");
		tearDownDriver();
	}

...
public class TCCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedDAUPHINISLANDAL extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCDAUPHINISLANDAL"));
		markStageasComplete();
		Thread.sleep(1000);

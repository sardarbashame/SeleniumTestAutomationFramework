...
public class TCCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedFLMonroeCounty extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCFLMonroeCounty"));
		markStageasComplete();
		Thread.sleep(1000);

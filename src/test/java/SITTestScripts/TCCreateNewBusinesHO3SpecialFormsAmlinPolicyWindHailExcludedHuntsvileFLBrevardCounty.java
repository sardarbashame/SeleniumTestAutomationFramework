...
public class TCCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedHuntsvileFLBrevardCounty extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCFLBrevardCounty"));
		markStageasComplete();
		Thread.sleep(1000);

...
public class TCCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedNCDuckCity extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCNCDuckCity"));
		markStageasComplete();
		Thread.sleep(1000);

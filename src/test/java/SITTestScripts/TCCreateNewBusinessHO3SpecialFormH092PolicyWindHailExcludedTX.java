...
public class TCCreateNewBusinessHO3SpecialFormH092PolicyWindHailExcludedTX extends BaseTest {
...
//		Reporter.log(step3heading);
	...
	//	Reporter.log(step5heading);
						   
		//Risk Details Step
		Step5RiskDetailsStepTX risDetailsStep = new Step5RiskDetailsStepTX(driver);
		risDetailsStep.riskdetailstep(getParameters().getProperty("H092COVALIMIT"), getParameters().getProperty("AOPDEDUTIBLEPERCENTAGE"), getParameters().getProperty("WINDHAILDEDUTIBLETypeEXCLUDED")); 
			
//		Reporter.log("RiskDetailsStep Completed");
	...
	//	Reporter.log("LossHistoryStep Completed");
	...
	//	Reporter.log("Selected Product Completed");

...
public class TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailALMobileCounty36523 extends BaseTest {

	@Test
	public void CreateNewBusinessHO3SpecialFormH092PolicywithWindHailALMobileCounty36523() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCALMOBILECOUNTY36523"));
		markStageasComplete();
		Thread.sleep(1000);

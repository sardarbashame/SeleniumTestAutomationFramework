...
public class TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailALMobileCounty36528 extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCALMOBILECOUNTY"));
		markStageasComplete();
		Thread.sleep(1000);

...
public class TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailFLFranklinCounty32322 extends BaseTest {

	@Test
	public void TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailFLFranklinCounty() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCFLFRANKLINCOUNTY"));
		markStageasComplete();
		 Thread.sleep(1000);

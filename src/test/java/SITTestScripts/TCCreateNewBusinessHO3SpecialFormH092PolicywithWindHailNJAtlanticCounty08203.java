...
public class TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailNJAtlanticCounty08203 extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCNJAtlanticCounty"));
		markStageasComplete();
		Thread.sleep(1000);

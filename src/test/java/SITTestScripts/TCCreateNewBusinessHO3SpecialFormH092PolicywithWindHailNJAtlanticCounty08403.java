...
public class TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailNJAtlanticCounty08403 extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCNJ08403"));
		markStageasComplete();
		Thread.sleep(1000);

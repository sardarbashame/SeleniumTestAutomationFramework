...
public class TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailSC29585 extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCSC29585"));
		markStageasComplete();
		 Thread.sleep(1000);

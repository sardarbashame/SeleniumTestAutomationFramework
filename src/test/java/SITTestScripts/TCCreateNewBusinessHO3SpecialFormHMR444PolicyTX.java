...
public class TCCreateNewBusinessHO3SpecialFormHMR444PolicyTX extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		risDetailsStep.riskdetailstep(getParameters().getProperty("AMLINCOVALIMIT"), getParameters().getProperty("AOPDEDUTIBLEPERCENTAGE"), getParameters().getProperty("WINDHAILDEDUTIBLEEXCLUDED"));	 
		...
		selectProductsStep.selectproductsstep("Hiscox Mid Range 444");			 

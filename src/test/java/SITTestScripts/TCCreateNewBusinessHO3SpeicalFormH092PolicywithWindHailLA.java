...
import HWKSalesConsole.Step2InsuredNameRiskLocationStepLA;
...
public class TCCreateNewBusinessHO3SpeicalFormH092PolicywithWindHailLA extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		Step2InsuredNameRiskLocationStepLA insurednamerisklocstep = new Step2InsuredNameRiskLocationStepLA(driver);
		...
		risDetailsStep.riskdetailstep(
				"HOMEOWNERS",
				getParameters().getProperty("H092COVALIMITIL"), 
				getParameters().getProperty("H092COVCLIMITIL"), 

...
public class TCCreateNewBusinessHO5SpecialFormH092PolicywithWindHailAL extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		startQuoteStep.startstep(getParameters().getProperty("HO5COMPREHENSIVEFORM"));

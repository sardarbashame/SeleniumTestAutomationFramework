...
public class TCCreateNewBusinessHO3SpecialFormH092PolicywithWindHailMDState extends Listeners{
	...
	public void CreateVAVENEWBUSINESSPOLICYWITHWINDHAILFORTXLOCATION() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCMD"));
		markStageasComplete();
		Thread.sleep(1000);

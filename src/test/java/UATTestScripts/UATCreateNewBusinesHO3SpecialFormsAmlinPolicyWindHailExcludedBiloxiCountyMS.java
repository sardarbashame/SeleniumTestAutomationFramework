...
public class UATCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedBiloxiCountyMS extends BaseTest {

	@Test
	public void CreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedBiloxiCountyMS() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCMSBiloksiCounty"));
		markStageasComplete();
		Thread.sleep(1000);

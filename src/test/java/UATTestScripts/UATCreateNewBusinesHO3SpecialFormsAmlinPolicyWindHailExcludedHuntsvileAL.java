...
public class UATCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedHuntsvileAL extends BaseTest {

	@Test
	public void CreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedHuntsvileAL() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCHuntsvilleAL"));
		markStageasComplete();
		Thread.sleep(1000);

...
public class UATCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedJacksonCountyMS extends BaseTest {

	@Test
	public void CreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedJacksonCountyMS() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCMSJacksonCounty"));
		markStageasComplete();
		Thread.sleep(1000);

...
public class UATCreateNewBusinesHO3SpecialFormsAmlinPolicyWindHailExcludedNC extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		addriskloc.addRiskLoc(getParameters().getProperty("RISKLOCNC"));
		markStageasComplete();
		Thread.sleep(1000);

...
public class UATCreateNewBusinessDP3SpecialFormH092PolicywithWindHailAL extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		//Risk Details Step
		Step5RiskDetailsStepDwellingNonTX risDetailsStep = new Step5RiskDetailsStepDwellingNonTX(driver);

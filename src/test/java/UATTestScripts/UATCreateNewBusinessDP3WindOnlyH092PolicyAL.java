...
import HWKSalesConsole.Step5RiskDetailsStepDwellingWindOnlyNonTX;
...
public class UATCreateNewBusinessDP3WindOnlyH092PolicyAL extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		startQuoteStep.startstep(getParameters().getProperty("DP3WINDONLY"));
		...
		//Risk Details Step
		Step5RiskDetailsStepDwellingWindOnlyNonTX risDetailsStep = new Step5RiskDetailsStepDwellingWindOnlyNonTX(driver);

...
public class UATCreateNewBusinessVAVEPolicyTX extends BaseTest {
	...
	public void createQuote() throws InterruptedException,NullPointerException, IOException {
		...
		risDetailsStep.riskdetailstep(getParameters().getProperty("H092COVALIMIT"), getParameters().getProperty("AOPDEDUTIBLEPERCENTAGE"), getParameters().getProperty("WINDHAILDEDUTIBLETypeWINDHAIL"));		 
